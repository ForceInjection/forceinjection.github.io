...
7. vLLM, "DeepSeek V4 — Efficient Long-Context Attention in vLLM", 项目内参考文档: [deepseek_v4_attention_support.md](../vllm/module_analysis/deepseek_v4_attention_support.md)
