...
以矩阵乘法和 ResNet-50 为基础，对三类核心算子进行系统性 profiling，并结合 npu-smi 实时监控观察负载状态。
...
08_npu_profiling/
├── README.md
├── 01_npu_profiling.md    # 本文
└── profile_ops.py         # profiling 脚本
...
- **混合精度 (AMP)**：当前 FP32 达 71.84 TFLOPS；开启 AMP 后，FP16 理论峰值 ~320 TFLOPS，实际期望 ~200+ TFLOPS
